...
public class routes {
  ...
  public static final controllers.ReverseTestClass TestClass = new controllers.ReverseTestClass(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseTestClass TestClass = new controllers.javascript.ReverseTestClass(RoutesPrefix.byNamePrefix());
